...
//		echo '<div class="form-group '. $lesser .' '. $error . '">';
		...
		echo "	<label class='col-sm-3 control-label no-padding-right' for='$for'>$name</label>";
	...
	private function _build_text($id, $default, $class, $placeholder, $prepend, $append, $is_password = false) {
		...
		echo '<input type="'. $type .'" '. $readonly .' placeholder="'. $placeholder .'" class="col-xs-10 col-sm-5 '. $class . '" name="'. $id .'" id="'. $id .'" value="'. $value .'" /> ';
